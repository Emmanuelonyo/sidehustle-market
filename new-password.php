...
if (!isset($_GET['token'])){
    ...
    $chk = mysqli_query($conn,"SELECT * FROM users WHERE token='$token'" );
    $getdata = mysqli_fetch_array($chk);
    $email = $getdata['email'];
    $username = $getdata['username'];
    $chk1 = mysqli_num_rows($chk);
...
if (isset($_POST['update'])){
    ...
    $update = mysqli_query($conn, "UPDATE users SET  token='', pass='$md5pass' WHERE email='$email'" ) or die ($update);
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="update" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Change Password</button>
                                        </div>
                                    </div>
                                    <hr/>
                                     <div class="row">
